...
<body style="background-color: var(--color-bg);">
  ...
  <div class="pt-10 pb-6 px-6" x-data="{ open: false }" style="background-color: var(--color-black)">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <!-- Navigation -->
      <div>
        <h3 class="text-xl mb-4" style="color: var(--color-white); font-family: var(--font-base);">Navigation</h3>
        <ul class="space-y-2">
          <li><a href="<?= BASE_URL ?>/index.php" style="color: var(--color-white); font-family: var(--font-base);" style="color: var(--color-black); font-family: var(--font-base);class="hover:underline">Accueil</a></li>
      ...
      <!-- Mentions légales -->
      <div>
        <h3 class="text-xl mb-4 flex items-center justify-between md:block" style="color: var(--color-white); font-family: var(--font-base);">
          Mentions légales
        ...
        <ul class="space-y-2 md:block" x-show="open || window.innerWidth >= 768" x-transition>
      ...
      <!-- Réseaux sociaux -->
      <div>
        <h3 class="text-xl mb-4" style="color: var(--color-white); font-family: var(--font-base);">Suivez-nous</h3>
