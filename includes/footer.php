...
<body style="background-color: #e8e8e8;">
  ...
  <!-- ✅ FOOTER -->
  <div class="bg-gray-900 text-white pt-10 pb-6 px-6" x-data="{ open: false }">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#projets" class="hover:underline">Projets réalisés</a></li>
      ...
      <!-- Mentions légales -->
      <div>
        <h3 class="text-xl font-semibold mb-4 flex items-center justify-between md:block">
          Mentions légales
